...
//     version 1.14.2
//     from Assets/Unty/motiono.inputactions
//
...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/Unty/motiono.inputactions".
/// </summary>
/// <remarks>
...
public partial class @Motiono: IInputActionCollection2, IDisposable
{
    ...
    ~@Motiono()
    {
        UnityEngine.Debug.Assert(!m_Movimiento.enabled, "This will cause a leak and performance issues, Motiono.Movimiento.Disable() has not been called.");
    }
    ...
    {
        private @Motiono m_Wrapper;

        /// <summary>
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public MovimientoActions(@Motiono wrapper) { m_Wrapper = wrapper; }
        /// <summary>
